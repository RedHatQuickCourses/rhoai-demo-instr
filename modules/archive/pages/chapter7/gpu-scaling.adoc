...
image::chapter7/03-single-node-multi-gpu.png[A diagram showing a model sharded across multiple GPUs within a single node, align="center"]
...
image::chapter7/03-multi-node-multi-gpu.png[A diagram showing a model distributed across multiple nodes, with each node using multiple GPUs, align="center"]
