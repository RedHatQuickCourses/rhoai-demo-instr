...
image::labenv/serverless_operator.gif[width=600]
...
image::labenv/servicemesh_install.gif[width=600]
...
image::labenv/authorino_install.gif[width=600]
...
image::labenv/openshiftai_install_214.gif[width=600]
...
image::labenv/dsc_install_214.gif[width=600]
...
image::labenv/data_science_project.gif[width=600]
