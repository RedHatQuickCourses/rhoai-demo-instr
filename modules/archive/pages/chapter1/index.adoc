...
image::chapter1/MAAS-Arch-drawio.png[A high-level logical architecture diagram for MaaS, align="center"]
...
image::chapter1/MAAS-3scale architecture.png[A diagram showing the conceptual flow of a request through a MaaS architecture, align="center"]
